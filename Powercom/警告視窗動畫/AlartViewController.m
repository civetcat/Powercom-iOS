...
- (void)viewDidLoad
{
    ...
    [negativeView setFrame:CGRectMake(0, 90, 140, 50)];
    [negativeView.layer setAnchorPoint:CGPointMake(0.5, 1)];
    [negativeView setBackgroundColor:[UIColor colorWithRed:0.26 green:0 blue:0 alpha:1]];
    [negativeView.layer setZPosition:0];
    ...
    [positiveView setFrame:CGRectMake(140, 90, 140, 50)];
    ...
    //最大的框框顏色
    [titleHolder setBackgroundColor:[UIColor colorWithRed:0.5 green:0.6 blue:0.3 alpha:1]];
    titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 280, 120)];
    [titleLabel setText:Main_word];//主要要輸入的文字
...
- (void)showView:(UIViewController *)VC withMain:(NSString*)Main_Words withBody:(NSString*)Body_Words withTail:(NSString*)Tail_Words Enter:(NSString*)enter Cancel:(NSString*)cancel
{
    Main_word = Main_Words;
    Body_word = Body_Words;
    Tail_word = Tail_Words;
    Enter = enter;
    Cancel = cancel;
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag
{
    if (flag == YES) {
        ...
        {
            [titleLabel setText:Body_word]; //你確定嗎？
        }
        ...
        {
            [titleLabel setText:Tail_word]; //成功！
